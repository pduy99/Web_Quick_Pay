...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/styles/main.css"> <!-- The path is defined in Style.kt -->
</head>
<body>
<div class="container">
    ...
    <div class="qr-container">
        <img src="/static/momo_qr_code.jpg" alt="Momo QR Code" class="qr-code">
    </div>
    ...
    <div class="account-info">Name: PHAM HOANG PHUOC DUY</div>
    <div class="qr-container">
        <img src="/static/mb_bank_qr_code.jpg" alt="MB Bank QR Code" class="qr-code">
    </div>
</div>
</body>
</html>